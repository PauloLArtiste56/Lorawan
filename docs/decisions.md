...
| D8 | **Achat limité aux 4 sous-compteurs de zone** | L'arrivée générale est déjà comptée par le distributeur ; sa télérelève sera négociée séparément. Pour les quatre zones en petit diamètre, le mécanique R160 suffit : arbitrage clos, ultrasonique non justifié. La détection par minimum nocturne reste opérante zone par zone. |
