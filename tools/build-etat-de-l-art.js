...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      encadre([
        p([nb("Le point dur du projet. ", { bold: true }), nb("Une campagne de mesures publiée sur l'instrumentation de bâtiments profonds rapporte une atténuation d'environ 10 dB par plancher vers les étages, mais d'environ "), nb("55 dB pour atteindre le sous-sol", { bold: true }), nb(" [7]. Cet écart d'un facteur cinq explique pourquoi un bilan de liaison établi sur des étages courants ne se transpose pas à un local technique enterré — et pourquoi la campagne de mesures du livrable T3 est indispensable.")], { spacing: { after: 0, line: 250 } }),
      ]),
      p(""),
