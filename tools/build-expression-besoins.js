...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      table([1400, 8346], ["Repère", "Zone couverte"], [
        ["SC1", "Annexe / NE"],
        ["SC2", "Ve + toilettes"],
        ["SC3", "S4"],
        ["SC4", "S1 / Maupertuis"],
        ["CG", "Arrivée générale de l'ECAM"],
        ["V1", "Vanne d'isolement du S4"],
      ], { premierGras: true }),
      ...
      encadre([
        formule("Résidu  =  CG  −  ( SC1 + SC2 + SC3 + SC4 )"),
      ]),
      new Paragraph({ spacing: { after: 80 }, children: [] }),
      p([
        nb("CG étant l'arrivée générale, la formule ne porte que sur les quatre sous-compteurs de zone. "),
        nb("Ce résidu n'est pas la consommation des toilettes", { bold: true }),
        nb(" : il agrège le S2, le S3, les toilettes de l'étage, un ou deux points d'eau supplémentaires, les usages divers non comptés et les fuites du réseau."),
      ]),
      p([
        nb("Récupérer l'index de l'arrivée générale. ", { bold: true }),
        nb("Elle est déjà comptée, mais par le compteur du distributeur, qui ne remonte rien vers l'ECAM. Sans cet index au pas horaire, le résidu n'est pas calculable et aucune fuite n'est décelable dans le S2, le S3 ou l'étage. Deux voies : un module de télérelève clipsé sur le compteur du distributeur ou "),
      ...
      p([nb("b.  Relevé des canalisations. ", { bold: true }),
         nb("Relever le diamètre nominal, le type de raccord et la longueur droite disponible de part et d'autre, sans laquelle le compteur sort de sa classe de précision.")]),
      ...
      table([620, 4680, 4446], ["", "Question", "Pourquoi c'est bloquant"], [
        ["Q1", "Disposons-nous de nœuds compteurs d'impulsions ?", "Il faut soit un compteur avec Lorawan intégré (plus cher) soit un nœud compteurs d'impulsions associé a chaque sous compteur."],
      ...
      puce("L'index de l'arrivée générale est remonté au pas horaire, le bilan CG − (SC1 + SC2 + SC3 + SC4) est calculé et affiché."),
