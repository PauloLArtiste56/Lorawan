...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p([nb("Cadre métrologique. ", { bold: true }), nb("Directive MID annexe MI-001 [17], OIML R 49 [16], EN ISO 4064. Un sous-compteur interne ne servant pas de base à une facturation entre tiers, l'approbation MID n'est pas juridiquement requise — mais elle reste le meilleur repère de qualité et garantit des classes comparables d'un fabricant à l'autre. Un compteur est caractérisé par R = Q3/Q1, choisi dans la série normalisée 40, 50, 63, 80, 100, 125, 160, 200, 250, 315, 400, 500, 630, 800, 1000 (R160 = ancienne classe C), avec Q1 = Q3/R, Q2 = 1,6 × Q1 et Q4 = 1,25 × Q3.")]),
      encadre([
